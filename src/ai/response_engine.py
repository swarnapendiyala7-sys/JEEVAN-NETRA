...
def generate_response(question, context, tokenizer, model):
    """
    Hybrid JEEVAN AI response engine.

    FAISS provides the trusted knowledge context.
    FLAN-T5 is used only when it can produce a useful answer.
    """
